...
<div class="container">
    <ul class="breadcrumb"><span class="maincontentheading"></span> 
        ...
        <span  ng-controller="angular-bala-pops" class="badge cursor-pointer"  popover-trigger="mouseenter" popover="All products under Subcategory <?php echo($subcategory) ?> are listed with 12 records per page.From here you can send product enquiry for a particular product and also view its details.">Info</span>
    </ul>
