...
$myserverlink="http://$serverlink/enquiries/bom/retrieve?";
?>
...
<div class="col-sm-12" style="margin:5px;"><Br>
	<h4 class="pageheader"><span class="fa fa-database fa-breadcrumb" ></span>Bill Of Material(BOM) Enquiry</h4><br>
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    <div class="modal-body">
                                      ...
                                      <h5 >Bill Of Material Enquiry From Customer : <strong>{{entry.fname}}&nbsp;{{entry.lname}}</srong></h5>
