...
function enquiryform($scope,$http) {
	 $http.get("http://<?php echo($serverlink) ?>/enquiries/bom/retrieve")
...
<div class="col-sm-12" >
	<h3>Bill Of Material Enquiry List</h3>
    <ul class="breadcrumb breadcrumb-spacetop"><span class="maincontentheading">You are here:</span>
        ...
        <li class="active maincontentheadinginner">Bill Of Material</li>
	 </ul>
     <!-- display starts -->
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      ...
                                      <h4 class="modal-title">Bill Of Material Enquiry <small>From customer : </small> {{entry.fname}}&nbsp;{{entry.lname}}</h4>
